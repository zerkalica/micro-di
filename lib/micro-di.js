var proto,
	...
	Mapper = require('regexp-string-mapper');
...
proto._explainString = function MicroDi__explainString(string) {
	return this._mapper.map(string, this._mapVariables);
};
...
proto._convertPropertyValue = function MicroDi__convertPropertyValue(configValue, serviceName, noCheckLock) {
	...
	if (typeof configValue === 'string') {
		result = configValue.indexOf('@') === 0 ? this.get(configValue.substring(1)) : this._explainString(configValue);
